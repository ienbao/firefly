...
/**
 * Created by Ethan.Yang on 2018/4/8.
 */
public class DColorPalette extends Region {
    ...
    private final Label customColorLabel = new Label(FxmlAndLanguageUtils.getString("CUSTOM_COLOR"));
    ...
    public DColorPalette(ColorPicker colorPicker) {
...
//                    });
    ...
    private void buildCustomColors() {
        ...
        if (customColors.isEmpty()) {
            ...
            if (contextMenu == null) {
                MenuItem item = new MenuItem(FxmlAndLanguageUtils.getString("COLOR_REMOVE"));
                item.setOnAction(e -> {
...
//                                Utils.removeMnemonics(contextMenu, ColorSquare.this.getScene());
    ...
    private void fixPosition() {
        ...
        dialog.setX((sb.getWidth()-dialog.getWidth())/2);
        dialog.setY((sb.getHeight()-dialog.getHeight())/2);
    }
}
