 ...
 * @author Can Guan
 */
public class NewBasicDataFrame extends AbstractBasicDataFrame {
    //所有列名称
     ...
     */
    NewBasicDataFrame(List<TestItemWithTypeDto> testItemDtoList, List<RowDataDto> rowDataDtoList) {
...
//        }
    ...
    NewBasicDataFrame(List<TestItemWithTypeDto> testItemDtoList, TestItemDataset testItemDataset){
...
//        }
    ...
    public DataFrame subDataFrame(List<String> rowKeyList, List<String> testItemNameList) {
        ...
        return new NewBasicDataFrame(typeDtoList, rowDataDtoList);
    }
