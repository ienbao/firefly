...
public class AreaSeries<X, Y> {
    ...
    public Group buildAreaGroup(XYChart.Series areaSeries) {
    ...
    public Group buildAreaGroup(IXYChartData<X, Y> xyOneChartData) {

        XYChart.Series areaSeries = this.buildSeries(xyOneChartData);
        // create new paths for series
        Path seriesLine = new Path();
        Path fillPath = new Path();
        fillPath.setFill(new Color(0.56078434f, 0.7372549f, 0.56078434f, 0.5));
