...
//    public static final String[] SPC_RULE_R = new String[]{"R1", "R2", "R3", "R4", "R5", "R6", "R7", "R8", "R9"};
    ...
    public static final String[] SPC_CHART_NDC_EXTERN_MENU = new String[] {
            ...
            SpcFxmlAndLanguageUtils.getString("SPC_CHART_ND_EXTERN_MENU_2_Σ"),
            SpcFxmlAndLanguageUtils.getString("SPC_CHART_ND_EXTERN_MENU_Σ"),
            SpcFxmlAndLanguageUtils.getString("SPC_CHART_ND_EXTERN_MENU_Μ"),
            SpcFxmlAndLanguageUtils.getString("SPC_CHART_ND_EXTERN_MENU_NEGATIVE_Σ"),
            SpcFxmlAndLanguageUtils.getString("SPC_CHART_ND_EXTERN_MENU_NEGATIVE_2Σ"),
    ...
    public static final String[] SPC_CHART_RUN_EXTERN_MENU = new String[] {
            ...
            SpcFxmlAndLanguageUtils.getString("SPC_CHART_RUN_EXTERN_MENU_NEGATIVE_2_Σ"),
            SpcFxmlAndLanguageUtils.getString("SPC_CHART_RUN_EXTERN_MENU_NEGATIVE_Σ"),
            SpcFxmlAndLanguageUtils.getString("SPC_CHART_RUN_EXTERN_MENU_Μ"),
            SpcFxmlAndLanguageUtils.getString("SPC_CHART_RUN_EXTERN_MENU_Σ"),
            SpcFxmlAndLanguageUtils.getString("SPC_CHART_RUN_EXTERN_MENU_2_Σ"),
    ...
    public static final String[] SPC_CHART_CONTROL_EXTERN_MENU = new String[] {
            ...
            SpcFxmlAndLanguageUtils.getString("SPC_CHART_CONTROL_EXTERN_MENU_Μ"),
    ...
    public static final String[] SPC_CHART_LINE_NAME = new String[] {
            ...
            SpcFxmlAndLanguageUtils.getString("SPC_CHART_LINE_NAME_NEGATIVE_2_Σ"),
            SpcFxmlAndLanguageUtils.getString("SPC_CHART_LINE_NAME_NEGATIVE_Σ"),
            SpcFxmlAndLanguageUtils.getString("SPC_CHART_LINE_NAME_Μ"),
            SpcFxmlAndLanguageUtils.getString("SPC_CHART_LINE_NAME_Σ"),
            SpcFxmlAndLanguageUtils.getString("SPC_CHART_LINE_NAME_2Σ"),
