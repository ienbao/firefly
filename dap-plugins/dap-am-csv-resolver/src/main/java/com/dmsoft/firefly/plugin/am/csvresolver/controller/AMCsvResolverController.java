 ...
 */
package com.dmsoft.firefly.plugin.am.csvresolver.controller;

import com.dmsoft.firefly.gui.components.utils.StageMap;
import com.dmsoft.firefly.gui.components.utils.TooltipUtil;
import com.dmsoft.firefly.gui.components.window.WindowMessageFactory;
import com.dmsoft.firefly.plugin.am.csvresolver.dto.CsvTemplateDto;
import com.dmsoft.firefly.plugin.am.csvresolver.model.RowDataModel;
 ...
 */
public class AMCsvResolverController {
    ...
    private void initComponentEvent() {
        ...
        item.setOnAction(event -> {
            ...
            if (item.getValue() == null || StringUtils.isEmpty(item.getValue().toString())) {
                TooltipUtil.installWarnTooltip(item, CsvFxmlAndLanguageUtils.getString("CSV_RESOLVE_TIP_NO_EMPTY"));
        ...
        data.setOnAction(event -> {
            ...
            if (data.getValue() == null || StringUtils.isEmpty(data.getValue().toString())) {
                TooltipUtil.installWarnTooltip(data, CsvFxmlAndLanguageUtils.getString("CSV_RESOLVE_TIP_NO_EMPTY"));
        ...
        browse.setOnAction(event -> {
            ...
            if (!filePath.exists()) {
                WindowMessageFactory.createWindowMessageHasOk("Message", CsvFxmlAndLanguageUtils.getString("CSV_RESOLVE_MESSAGE_FILE_NOT_EXIST"));
                return;
            }
            ...
            File file = fileChooser.showOpenDialog(StageMap.getStage(ResourceMassages.AM_STAGE_CSV));
        ...
        ok.setOnAction(event -> {
            if (item.getStyleClass().contains("combo-box-error") || data.getStyleClass().contains("combo-box-error")) {
                WindowMessageFactory.createWindowMessageHasCancel("Message", CsvFxmlAndLanguageUtils.getString("CSV_RESOLVE_MESSAGE_TEST_DATA_PARAM_ERROR"));
                return;
            }
            save();
            StageMap.closeStage(ResourceMassages.AM_STAGE_CSV);
        });
