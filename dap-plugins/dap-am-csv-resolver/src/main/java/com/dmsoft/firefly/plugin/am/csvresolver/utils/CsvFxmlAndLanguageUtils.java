 ...
 */
package com.dmsoft.firefly.plugin.am.csvresolver.utils;
...
public class CsvFxmlAndLanguageUtils {
    ...
    public static FXMLLoader getLoaderFXML(String res) {
        ...
        if (!isDebug) {
            fxmlLoader.setClassLoader(RuntimeContext.getBean(PluginContext.class).getDAPClassLoader("com.dmsoft.dap.AMCsvResolverPlugin"));
        }
