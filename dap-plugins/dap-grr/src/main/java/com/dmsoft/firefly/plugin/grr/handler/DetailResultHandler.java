 ...
 */
public class DetailResultHandler implements JobInboundHandler {
    ...
    public void doJob(JobHandlerContext context, Object... in) throws Exception {
        ...
        TestItemWithTypeDto itemWithTypeDtos = (TestItemWithTypeDto) param.get(ParamKeys.TEST_ITEM_WITH_TYPE_DTO);
        ...
        String itemName = itemWithTypeDtos.getTestItemName();
