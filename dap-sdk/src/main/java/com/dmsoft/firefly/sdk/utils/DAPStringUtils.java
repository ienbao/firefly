...
public class DAPStringUtils extends StringUtils {
    ...
    public static boolean isSpecialBlank(String data) {
        return StringUtils.isBlank(data) || data.equalsIgnoreCase("N/A") || data.equalsIgnoreCase("-") || data.equalsIgnoreCase("nil") || data.equalsIgnoreCase("UnKnown Line") || data.equalsIgnoreCase("_");
    }
