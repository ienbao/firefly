 ...
 * @param <E>
 */
public class HashListSet<E> implements List<E> {
  ...
  public HashListSet(int initSize){
   ...
   * end of the list is set to <tt>null</tt>. (This is useful in determining the length of the list
   ...
   * empty.)  The returned list is backed by this list, so non-structural changes in the returned
   * list are reflected in this list, and vice-versa. The returned list supports all of the optional
